...
const EntertainmetCard = (props) => {
  return (
    <>
    <div className='w-full h-30 px-2 '>
      <img className='w-full h-full rounded-lg ' src={props.src} alt='entertaiments'/>
...
const EntertainmentCardSlider=()=>{
  ...
  return<>
  <Slider {...settings}>
    {EntertaimentsImage.map((image,index) => 
     <EntertainmetCard src={image} key={index}/> 
    )}
